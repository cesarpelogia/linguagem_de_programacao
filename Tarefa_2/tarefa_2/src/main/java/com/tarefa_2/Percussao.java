...
public class Percussao {
    ...
    public boolean setSurdo(boolean surdo) {
        return surdo = this.surdo;
    }

    public boolean setChimbal(boolean chimbal) {
        return chimbal = this.chimbal;
    }

    public int setTotalPecas(int totalPecas) {
        return totalPecas = this.totalPecas;
    }

    public String setModeloP(String modelo) {
        return modelo = this.modeloP;
    }
}
