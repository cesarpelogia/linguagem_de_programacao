...
public class RecoReco {
    ...
    public String setModeloR(String modeloR) {
        return modeloR = this.modeloR;
    }

    public int setPesoR(int pesoR) {
        return pesoR = this.pesoR;
    }

    public String setEstadoR(String estadoR) {
        return estadoR = this.estadoR;
    }
}
